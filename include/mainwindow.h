...
private:
    QWidget *centralWidget; ///< Pointer to the central widget, which holds all main UI elements.
    QVBoxLayout *layout; ///< Layout for organizing the widgets vertically.

    QLabel *titleLabel; ///< Label displaying the application title.

    PreGame *preGameWindow; ///< Pointer to the PreGame window for local gameplay setup.
    ...
    QPushButton *createAccountButton; ///< Button for opening the account creation window.

    User *onlineGameWindow; ///< Pointer to the online game window where users can play multiplayer.
    CreateAccountWindow *createAccountWindow; ///< Pointer to the account creation window.
    StatisticsWindow *statsWindow; ///< Pointer to the statistics window displaying game stats.
    Tutorial *tutorialWindow; ///< Pointer to the tutorial window explaining the game mechanics.
};
