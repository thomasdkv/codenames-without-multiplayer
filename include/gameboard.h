/**
 * @file gameboard.h
 * @brief Header file for the GameBoard class, which implements a game board for
 * the Spy Master game.
 * @author Group 9
 */
 ...
 *
 * @details The GameBoard class is responsible for displaying the game board and
 * handling user interactions. It includes methods for loading words from a
 * file, generating the game grid, setting up the UI, card clicks, card reveals
 * and turns, and handling game end conditions. The game board also includes a
 * stacked layout for transitions between screens. Codenames is a game which
 * involves two teams (red and blue) with spymasters giving hints and operators
 * making guesses.
 *
 * @author Group 9
 */
...
class GameBoard : public QWidget {
 ...
 public:
   ...
   *
   * @details Initializes the game board with the provided team names and sets
   * up the UI. It also loads words from a file and generates the game grid
   ...
   *
   * @details Sets the names of the red team's operative and updates the team
   * labels.
   *
   ...
   *
   * @details Sets the names of the blue team's spymaster and operative and
   * updates the team labels.
   *
   ...
   *
   * @details Sets the names of the blue team's operative and updates the team
   * labels.
   *
   ...
   *
   * @details Updates the labels displaying team information, such as team names
   * and scores.
   *
   * @author Group 9
   */
 ...
 signals:
   ...
   *
   * @details Signals that the game has ended and the game board should be
   * closed.
   *
   * @author Group 9
   */
 ...
 public slots:
   ...
   *
   * @details Displays a hint on the game board for the current turn and updates
   * the UI.
   *
   ...
   *
   * @details Displays a guess on the game board for the current turn and
   * updates the UI.
   *
   * @author Group 9
   */
 ...
 private:
   ...
   *
   * @details Sets up the UI for the game board, including the layout, labels,
   * and buttons.
   *
   * @author Group 9
   */
   ...
   *
   * @details Updates the scores of the teams based on the current state of the
   * game.
   *
   * @author Group 9
   */
   ...
   *
   * @details Checks if the game has ended based on the current state of the
   * game.
   *
   * @author Group 9
   */
