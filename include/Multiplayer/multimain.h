/**
 * @file multimain.h
 * @brief Header file for the MultiMain class, which implements the main multiplayer game lobby interface.
 * @author Your Name
 */
...
/**
 * @class MultiMain
 * @brief A widget that implements the main multiplayer lobby for creating and joining game rooms.
 * 
 * @details The MultiMain class provides the interface for players to either create a new game room
 * as a host or join an existing game room as a client. It manages WebSocket connections
 * for multiplayer functionality and handles the transition to the pre-game setup screen.
 * 
 * @author Your Name
 */
...
public:
     ...
     * 
     * @details Initializes the multiplayer lobby interface with buttons for creating
     * and joining game rooms. Sets up the UI components and prepares network connections.
     * 
     ...
     * 
     * @details Makes the multiplayer lobby interface visible and sets up initial state.
     * 
     * @author Your Name
     */
    void showMainWindow();
...
signals:
     ...
     * 
     * @details Triggered when a player joins an existing game room and transitions
     * to the pre-game setup screen as a client.
     * 
