#############################################################################
# Makefile for building: Codenames.app/Contents/MacOS/Codenames
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  CMakeLists.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile CMakeLists.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Codenames1.0.0
DISTDIR = /Users/ashton/Documents/Code/codenames/.tmp/Codenames1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		CMakeLists.pro  main.cpp
QMAKE_TARGET  = Codenames
DESTDIR       = 
TARGET        = Codenames.app/Contents/MacOS/Codenames

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/ashton/Documents/Code/codenames/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/ashton/Documents/Code/codenames/CMakeLists.pro
...
Codenames.app/Contents/MacOS/Codenames:  $(OBJECTS)  
	@test -d Codenames.app/Contents/MacOS/ || mkdir -p Codenames.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: CMakeLists.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile CMakeLists.pro
...
Codenames.app/Contents/PkgInfo: 
	@test -d Codenames.app/Contents || mkdir -p Codenames.app/Contents
	@$(DEL_FILE) Codenames.app/Contents/PkgInfo
	@echo "APPL????" > Codenames.app/Contents/PkgInfo
Codenames.app/Contents/Info.plist: 
	@test -d Codenames.app/Contents || mkdir -p Codenames.app/Contents
	@$(DEL_FILE) Codenames.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Codenames,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Codenames,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Codenames,g" -e "s,@LIBRARY@,Codenames,g" -e "s,\$${EXECUTABLE_NAME},Codenames,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Codenames.app/Contents/Info.plist

all: Makefile \
		Codenames.app/Contents/PkgInfo \
		Codenames.app/Contents/Info.plist Codenames.app/Contents/MacOS/Codenames
